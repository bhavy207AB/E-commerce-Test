...
var TestdinoReporter = class _TestdinoReporter {
  ...
  async onEnd(result) {
    ...
    if (result.status === "failed" && this.failedFinalTests.size >= 1 && this.coverageThresholdFailures.length === 0 && [...this.failedFinalTests.values()].every((entry) => entry.quarantined)) {
      this.log.info(
